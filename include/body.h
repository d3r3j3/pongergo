...
/**
 * Scales the body in the y-direction by a given scalar.
 *
 * @param body, a pointer to a body given by the user
 * @param scalar, a scalar to scale the body in the y -direction
 */
 ...
 * @param v the body's new velocity
 */
void body_set_max_velocity(body_t *body, double m);
...
/**
 * Returns the force attribute of a body
 *
 * @param body a pointer to a body returned from body_init()
 */
